    ...
    <div className="bg-white p-6 sm:p-8 rounded-3xl border border-neutral-200 shadow-sm h-full">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-100">
          <h3 className="font-bold text-neutral-900 mb-2">{t('grade9Title')}</h3>
          <p className="text-sm text-neutral-600">{t('grade9Desc')}</p>
        </div>
        <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-100">
          <h3 className="font-bold text-neutral-900 mb-2">{t('grade11Title')}</h3>
          <p className="text-sm text-neutral-600">{t('grade11Desc')}</p>
        </div>
      ...
      <div>
        ...
        <ul className="space-y-3 mb-6">
          <li className="flex items-center justify-between text-sm">
            <span className="text-neutral-600">{t('quotaMultiChildren')}</span>
            <span className="font-bold text-success">{t('quotaValue', { value: 5 })}</span>
          </li>
          <li className="flex items-center justify-between text-sm">
            <span className="text-neutral-600">{t('quotaRural')}</span>
            <span className="font-bold text-success">{t('quotaValue', { value: 30 })}</span>
          </li>
          <li className="flex items-center justify-between text-sm">
            <span className="text-neutral-600">{t('quotaOrphans')}</span>
