...
const CATEGORIES = [
  { icon: MonitorPlay, name: "IT и Программирование", count: "12 колледжей" },
  { icon: Stethoscope, name: "Медицина и Здоровье", count: "5 колледжей" },
  { icon: BookOpen, name: "Педагогика", count: "8 колледжей" },
  { icon: HardHat, name: "Строительство и Архитектура", count: "10 колледжей" },
  { icon: Briefcase, name: "Бизнес и Управление", count: "15 колледжей" },
  { icon: Calculator, name: "Экономика и Финансы", count: "14 колледжей" },
];
  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl font-serif font-bold text-neutral-900 mb-4">Направления обучения</h2>
        <p className="text-neutral-500 max-w-2xl mx-auto mb-16 text-lg">
          Выберите интересную вам сферу, чтобы посмотреть доступные специальности и колледжи.
        </p>
