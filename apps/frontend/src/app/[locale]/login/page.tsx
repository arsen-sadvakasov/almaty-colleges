  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors">
        <div className="max-w-md w-full bg-white dark:bg-neutral-900 p-8 sm:p-10 rounded-3xl shadow-xl border border-neutral-100 dark:border-neutral-800 transition-colors">
